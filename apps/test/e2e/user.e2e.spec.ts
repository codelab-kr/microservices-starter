...
import { AppModule } from '@app/common/enhancer/app.module';
import { setupApp } from '../../../libs/common/src/config/common';
  ...
  describe('GET /users', () => {
    it('200(OK)과 생성된 모든 유저 목록을 json 타입으로 응답한다', async () => {
      await userRepository.save([
        { firstName: 'Tei', lastName: 'Lee' },
        { firstName: '태의', lastName: '이' },
      ]);
